...
namespace XRAccelerator.Gameplay
{
    public class InteractionPose : MonoBehaviour
    {
        ...
        {
            if(interactor.GetComponentInChildren<HandVisuals>() != null) interactor.GetComponentInChildren<HandVisuals>().LockPose(interactionPose);
        }

        private void OnGrabRelease(XRBaseInteractor interactor)
        {
            if (interactor.GetComponentInChildren<HandVisuals>() != null) interactor.GetComponentInChildren<HandVisuals>().UnlockPose();
        }
